...
- [confluentinc/ksql](https://github.com/confluentinc/ksql) - The database purpose-built for stream processing applications. (4 days ago)
- [bugthesystem/vscode-open-in-github](https://github.com/bugthesystem/vscode-open-in-github) - Extension for Visual Studio Code which can be used to jump to a source code line in Github, Bitbucket, GitLab and Visualstudio.com (4 days ago)
- [vacanza/python-holidays](https://github.com/vacanza/python-holidays) - Generate and work with holidays in Python (5 days ago)
